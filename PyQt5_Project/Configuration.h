...
#define CUSTOM_MACHINE_NAME "Katman"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "c1_sn224"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 151.55
  #define DEFAULT_bedKi 13.81
  #define DEFAULT_bedKd 1109.11
...
// derlesin diye veri ekledim 1 2 3 4 5 6 7 8

// Mechanical endstop with COM to ground and NC to Signal uses "false" here (most common setup).
#define X_MIN_ENDSTOP_INVERTING true //"true idi" Set to true to invert the logic of the endstop. 
#define Y_MIN_ENDSTOP_INVERTING true //"true idi" Set to true to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_INVERTING false //"false idi" Set to true to invert the logic of the endstop.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 30, -1 }
...
#define X_BED_SIZE 325  //320 idi elektrik kesintisi icin artirdim
#define Y_BED_SIZE 320  //315 idi elektrik kesintisi icin artirdim
...
//#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M125 P1 L5"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 6 //*** burayi 6 yap simdilik hizlansin diye degistirdim
...
#define LCD_FEEDBACK_FREQUENCY_HZ 880
